...
# Define variable
generate_alias_script = '.git_aliases_temp'
target_file = './linux/alias/git/.git_aliases'
start_marker = '#START: Autogenerated by generate_aliases.py'
end_marker = '#END: Autogenerated by generate_aliases.py'
# Run the command and get the output
result = subprocess.run(['cat', generate_alias_script], stdout=subprocess.PIPE, text=True)
