...
init_globals() {
    ...
    # OS-specific installer script path in your repo
    case "$OS" in
        macos)   REPO_OS_PATH="linux"   ;;
        ubuntu)  REPO_OS_PATH="linux"   ;;
    esac
...
zsh_theme_install() {
    curl -sS "https://raw.githubusercontent.com/khangtictoc/Productive-Workspace-Set-Up/refs/heads/main/$REPO_OS_PATH/installation/terminal/ui/theme/oh-my-posh/install.sh" | bash
    curl -sS "https://raw.githubusercontent.com/khangtictoc/Productive-Workspace-Set-Up/refs/heads/main/$REPO_OS_PATH/installation/terminal/ui/theme/oh-my-posh/configure-zsh.sh" | bash
}

# --- Zsh Plugins ------------------------------------------------

zsh_plugins_install() {
    curl -sS "https://raw.githubusercontent.com/khangtictoc/Productive-Workspace-Set-Up/refs/heads/main/$REPO_OS_PATH/installation/terminal/plugins/fzf/install.sh" | bash
    curl -sS "https://raw.githubusercontent.com/khangtictoc/Productive-Workspace-Set-Up/refs/heads/main/$REPO_OS_PATH/installation/terminal/shell/zsh/plugins.sh" | bash
}
...
setup_git_profile() {
    ...
    curl -sL "https://raw.githubusercontent.com/khangtictoc/Productive-Workspace-Set-Up/refs/heads/main/$REPO_OS_PATH/utility/configuration/git/profile/$DEFAULT_GIT_PROFILE.sh" | bash
...
setup_git_hooks() {
    ...
    download_file \
        "https://raw.githubusercontent.com/khangtictoc/Productive-Workspace-Set-Up/refs/heads/main/$REPO_OS_PATH/utility/configuration/git/hook/pre-push" \
...
shell_config_motd_self_custom() {
    download_file \
        "https://raw.githubusercontent.com/khangtictoc/Productive-Workspace-Set-Up/refs/heads/main/$REPO_OS_PATH/installation/terminal/ui/startup/self-customed/motd.sh" \
        "$MOTD_DIR/motd.sh"
...
shell_config_motd_neofetch() {
    ...
    download_file \
        "https://raw.githubusercontent.com/khangtictoc/Productive-Workspace-Set-Up/refs/heads/main/$REPO_OS_PATH/installation/terminal/ui/startup/neofetch/motd.sh" \
        "$MOTD_DIR/motd.sh"
    chmod +x "$MOTD_DIR/motd.sh"
    log_success "✅ - Neofetch MOTD script downloaded!"

    download_file \
        "https://raw.githubusercontent.com/khangtictoc/Productive-Workspace-Set-Up/refs/heads/main/$REPO_OS_PATH/installation/terminal/ui/startup/neofetch/cat_in_the_box.txt" \
        "$MOTD_DIR/cat_in_the_box.txt"
    log_success "✅ - ASCII art theme downloaded!"

    mkdir -p "$HOME/.config/neofetch"
    download_file \
        "https://raw.githubusercontent.com/khangtictoc/Productive-Workspace-Set-Up/refs/heads/main/$REPO_OS_PATH/installation/terminal/ui/startup/neofetch/config.conf" \
...
main() {
    ...
    echo
    source <(curl -sS "https://raw.githubusercontent.com/khangtictoc/Productive-Workspace-Set-Up/refs/heads/main/$REPO_OS_PATH/utility/library/bash/ansi_color.sh")
    init-ansicolor
