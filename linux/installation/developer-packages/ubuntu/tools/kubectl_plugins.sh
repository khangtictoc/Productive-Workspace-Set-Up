...
KREW="krew-${OS}_${ARCH}" &&
wget --progress=dot:giga "https://github.com/kubernetes-sigs/krew/releases/latest/download/${KREW}.tar.gz" &&
...
## Kubectl Node Shell
wget --progress=dot:giga https://github.com/kvaps/kubectl-node-shell/raw/master/kubectl-node_shell
